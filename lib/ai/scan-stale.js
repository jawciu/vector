 ...
 * = "I'll send this myself" (no DB mutation; just a record). Reject = ignore.
 *
 * Cost / approval-fatigue guards:
 *   - MAX_DRAFTS_PER_ONBOARDING per onboarding
...
const MAX_DRAFTS_PER_ONBOARDING = 2;
...
export async function scanStaleTasks({ scopeVendorId = null } = {}) {
  ...
  for (const ob of onboardings) {
    ...
    const stale = tasks
      ...
      .slice(0, MAX_DRAFTS_PER_ONBOARDING);
