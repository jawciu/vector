...
6. \`wins[]\` (max 2): each item is a real event from the last 7 days with concrete evidence. \`headline\` is the company name (e.g. "Acme Co"). \`detail\` is what happened (e.g. "moved from At Risk to On Track"). If no real wins exist, return [].
