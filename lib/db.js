...
/**
 * Write an activity log row. Feeds the notification inbox + banner (step 3)
 * and Phase 3 AI summaries. Never throws into the mutation path — failures
 * are logged and swallowed so activity logging can't break the action that
 * triggered it.
 *
 * actor shapes:
