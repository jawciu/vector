...
2b. **Tab bar** (added 2026-09-11): the customer portal's tab strip moves onto the existing TabBar component. Three pill-style switchers (pipeline filter, onboarding type, follow-up tone) look different from underline tabs, so Caroline decides whether they become TabBar or a small new segmented control.
